...
export default class ConstantsApp
{
	...
	static readonly mapDatas : { [mapkey:string]:MapData; } = {
		// URBAN
		sac: { name:"sac", mapAsset:"sac_map", iconAsset:"sac_icon", spawnX:642, spawnY:612, spawnTileX:117, spawnTileY:109, scale:81/758,//3.923076923076923/MapScreen.TILE_DIAG
		...
		bay: { name:"bay", mapAsset:"bodega_map", iconAsset:"bodega_icon", spawnX:1792, spawnY:1363, spawnTileX:169, spawnTileY:227, scale:105/600,
			loadList:[
		...
		santa: { name:"santa", mapAsset:"santa_map", iconAsset:"santa_icon", spawnX:475, spawnY:1024, spawnTileX:149, spawnTileY:190, scale:60/420,
			loadList:[
		...
		mazon: { name:"mazon", mapAsset:"mazon_map", iconAsset:"mazon_icon", spawnX:1450, spawnY:1160, spawnTileX:306, spawnTileY:203, scale:44/240,
			loadList:[
		...
		mall: { name:"mall", mapAsset:"mall_map", iconAsset:"mall_icon", spawnX:1345, spawnY:531, spawnTileX:229, spawnTileY:86, scale:82/660,
			loadList:[
		...
		// DESERT
		walker: { name:"walker", mapAsset:"walker_map", iconAsset:"walker_icon", spawnX:3714, spawnY:420, spawnTileX:460, spawnTileY:298, scale:45/300,
			loadList:[
		...
		museum: { name:"museum", mapAsset:"museum_map", iconAsset:"museum_icon", spawnX:1333, spawnY:722, spawnTileX:262, spawnTileY:90, scale:117/640,
			loadList:[
		...
		highway: { name:"highway", mapAsset:"highway_map", iconAsset:"highway_icon", spawnX:154, spawnY:1974, spawnTileX:41, spawnTileY:144, scale:158/904,
			loadList:[
		...
		mesa: { name:"mesa", mapAsset:"mesa_map", iconAsset:"mesa_icon", spawnX:430, spawnY:1004, spawnTileX:50, spawnTileY:65, scale:180/980,
			loadList:[
